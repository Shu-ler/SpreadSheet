...
namespace ASTImpl {
	...
	// Глубокая переработка - проблема совместимости моей среды разработки
	// с тренажёром и коварный тест с "R2D2"
...
// Всё тот же "R2D2" заставил ловить исключение через try...catch 
